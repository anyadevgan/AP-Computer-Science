public class Screen
{
   ...
   public void printScreen()
   {
      ...
      System.out.println(); //why have this here?
      }
   }
   ...
   private void addWindow(Window newWindow)
   {
      ...
      for (int r = 0; r < win.length; r++) //win.length = height
      {
         for (int c = 0; c < win[0].length; c++) //win[0].length = width
         {
            if(r + newWindow.getY() < HEIGHT-1 && c + newWindow.getX() < WIDTH-1)
            {
