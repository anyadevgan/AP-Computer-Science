 ...
 * Author: Maddy 
 * Date: Jan 15
 * Description: Desktop mini project
 *
 */
...
public class Screen
{
   ...
   public Screen()
   {
   //Remove this comment and fill in the blanks to complete the default constructor
   ...
   //When ready, remove this comment block to allow these two versions of the openWindow method to be used/called/tested
   ...
   private void addWindow(Window newWindow)
   {
      ...
      for (int r = 0; r < newWindow.length(); r++)
      {
         for (int c = 0; c < newWindow.length(); c++)
         {
            frame[r][c] = 
